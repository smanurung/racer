...
function Update () {
	...
	BackLeftWheel.motorTorque = EngineTorque / GearRatio[CurrentGear] * inputTorque;
	BackRightWheel.motorTorque = EngineTorque / GearRatio[CurrentGear] * inputTorque;
		
	// the steer angle is an arbitrary value multiplied by the calculated AI input.
	FrontLeftWheel.steerAngle =30 * inputSteer;
	FrontRightWheel.steerAngle =30 * inputSteer;
}
